!(function (e, a) {
  ...
  (function (e) {
    ...
    function (e, a, i) {
      const n = 'https://www.kankakeechristianassembly.org/sitemap.xml',
        o = i(29);
      a.handler = async (e) => {
        try {
      ...
      e.exports = function (e) {
        return new Promise(function (a, i) {
          ...
          var O = s(e.baseURL, e.url),
            ...
            T = z.protocol || b[0];
          if (-1 === b.indexOf(T))
            return j(new f('Unsupported protocol ' + T, f.ERR_BAD_REQUEST, e));
          if (!R && z.auth) {
            var S = z.auth.split(':');
            R = (S[0] || '') + ':' + (S[1] || '');
          }
          ...
          U &&
            ...
            (function e(a, i, n) {
              ...
              A,
              U,
              T + '//' + z.hostname + (z.port ? ':' + z.port : '') + A.path,
            ));
